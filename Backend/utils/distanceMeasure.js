...
// Function that calculates distance for an admin and returns notifications
async function distanceMeasure(userId) {
  try {
    ...
    for (const groupId of userData.groups) {
      ...
      for (const memberId of groupData.members) {
        ...
        if (distance > 2000) {
          ...
          // Optional: Save notification in Firestore
    ...
    console.error("Error in distanceMeasureForAdmin:", error);
    throw error;
  }
}
